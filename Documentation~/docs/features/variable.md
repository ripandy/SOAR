...
The [`JsonableExtensions`](jsonable-extension.md) class provides helper methods like `SaveToJson` and `LoadFromJson` to easily save/load `IJsonable` objects to/from files.
